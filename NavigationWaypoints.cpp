...
{{
  ...
  [41] = { ._label = "39N London Black Cab 7m", ._m5label = "39N\n\nLondon\nBlack\nCab\n\n7m", ._cat=NO_BUOY, ._lat = 51.459729, ._long = -0.546992857142857},
  [42] = { ._label = "40N RIB Boat 6m", ._m5label = "40N\n\nRIB\nBoat\n\n6m", ._cat=NO_BUOY, ._lat = 51.460236, ._long = -0.546847571428571},
  [43] = { ._label = "41N Tin/Cabin Boat 7m", ._m5label = "41N\n\nTin\nCabin\nBoat\n\n7m", ._cat=NO_BUOY, ._lat = 51.459676625, ._long = -0.5468125},
  [44] = { ._label = "42P 6m", ._m5label = "42P 6m", ._cat=PLATFORM, ._lat = 51.459491, ._long = -0.546867},
  [45] = { ._label = "43N Thorpe Orange Boat 5.5m", ._m5label = "43N\n\nThorpe\nOrange\nBoat\n\n5.5m", ._cat=NO_BUOY, ._lat = 51.4602073333333, ._long = -0.546787666666667},
  [46] = { ._label = "44N VW Camper Van and Seahorse 5.5m", ._m5label = "44N\nVW\nCamper\nVan and\nSeahors\n\n5.5m", ._cat=NO_BUOY, ._lat = 51.459368, ._long = -0.546760142857143},
  [47] = { ._label = "45B Listing Sharon 7.5m", ._m5label = "45B\n\nListing\nSharon\n\n7.5m", BLUE_BUOY, ._lat = 51.4598098699702, ._long = -0.54670373432756},
  [48] = { ._label = "46N Plane 6m", ._m5label = "46N\n\nPlane\n\n6m", ._cat=NO_BUOY, ._lat = 51.459745, ._long = -0.546649},
  [49] = { ._label = "47P 6m", ._m5label = "47P 6m", ._cat=PLATFORM, ._lat = 51.459399, ._long = -0.546594},
  [50] = { ._label = "48N Holey Ship 4.5m", ._m5label = "48N\nHoley\nShip", ._cat=NO_BUOY, ._lat = 51.4594384444444, ._long = -0.5465238},
  [51] = { ._label = "49B Claymore 6.5m", ._m5label = "49B\n\nClay-\n   more\n\n6.5m", BLUE_BUOY, ._lat = 51.459634435324, ._long = -0.54646635372985},
  [52] = { ._label = "50aN Swim Through - no crates 6m", ._m5label = "50aN\nSwim\nThrough\nno\ncrates\n\n6m", ._cat=UNMARKED, ._lat = 51.45914367, ._long = -0.546032333},
  [53] = { ._label = "50bN Swim Through - mid 6m", ._m5label = "50bN\nSwim\nThrough\nmid 6m", ._cat=NO_BUOY, ._lat = 51.4591694, ._long = -0.545999},
  [54] = { ._label = "50cN Swim Through - crates 6m", ._m5label = "50cN\nSwim\nThrough\ncrates\n6m", ._cat=NO_BUOY, ._lat = 51.4592045, ._long = -0.545912625},
  [55] = { ._label = "51B Orca Van 5.5m", ._m5label = "51B\n\nOrca\nVan\n\n5.5m", BLUE_BUOY, ._lat = 51.4591431428571, ._long = -0.545936857142857},
  
  [56] = { ._label = "X01 Dinghy Boat", ._m5label = "X01\nDinghy\nBoat", ._cat=UNMARKED,._lat = 51.4601285, ._long = -0.5488505},
  [57] = { ._label = "X02 Quarry Machine in Reeds", ._m5label = "X02\nQuarry\nMachine\nReeds", ._cat=UNMARKED, ._lat = 51.460434, ._long = -0.548921},
