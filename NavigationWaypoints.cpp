...
{{
  [0] =  { ._label = "01N Canoe", ._m5label = "01N\nCanoe", ._lat = 51.4620416774194, ._long = -0.548974709677419},
  [1] =  { ._label = "02N The Sub", ._m5label = "02N\nThe\nSub", ._lat = 51.4609042894737, ._long = -0.549211315789474},
  ...
  [17] = { ._label = "14P Cargo 8m", ._m5label = "14P\nCargo\n8m", ._lat = 51.4602986, ._long = -0.5483127},
  [18] = { ._label = "15P Cargo Rusty 8m", ._m5label = "15P\nCargo\nRusty\n8m", ._lat = 51.460192, ._long = -0.548283},
  [19] = { ._label = "16P Portacabin 8m", ._m5label = "16P\nPorta\ncabin\n8m", ._lat = 51.46034, ._long = -0.548173},
  [20] = { ._label = "17P Shallow Platform 2m", ._m5label = "17P 2m", ._lat = 51.4599705, ._long = -0.54810825},
  ...
  [29] = { ._label = "26N Iron Fish 2m", ._m5label = "26N\nIron\nFish\n2m", ._lat = 51.4595936666667, ._long = -0.547489833333333},
  ...
  [34] = { ._label = "31P 6m", ._m5label = "31P 6m", ._lat = 51.459766, ._long = -0.547347},
  [35] = { ._label = "32P 6m", ._m5label = "32P 6m", ._lat = 51.459658, ._long = -0.54725},
  [36] = { ._label = "33N New (Row) Boat 4.5m", ._m5label = "33N\nNew Row\nBoat\n4.5m", ._lat = 51.4595563333333, ._long = -0.547263333333333},
  [37] = { ._label = "34P 6m", ._m5label = "34P 6m", ._lat = 51.460312, ._long = -0.547165},
  [38] = { ._label = "35N Dragon Boat 7.5m", ._m5label = "35N\n\nDragon\nBoat\n\n7.5m", ._lat = 51.4599636666667, ._long = -0.547154333333333},
  [39] = { ._label = "36P 6m", ._m5label = "36P 6m", ._lat = 51.459555, ._long = -0.54708},
  ...
  [45] = { ._label = "42P 6m", ._m5label = "42P 6m", ._lat = 51.459491, ._long = -0.546867},
  ...
  [50] = { ._label = "47P 6m", ._m5label = "47P 6m", ._lat = 51.459399, ._long = -0.546594},
  [51] = { ._label = "48N Holey Ship 4.5m", ._m5label = "48N\nHoley\nShip", ._lat = 51.4594384444444, ._long = -0.5465238},
  ...
  [80] = { ._label = "CN1 Canoe NW", ._m5label = "CN1\nCanoe NW", ._lat = 51.4621272, ._long = -0.5490348},
  [81] = { ._label = "CN2 Canoe N", ._m5label = "CN2\nCanoe N", ._lat = 51.4621644, ._long = -0.5489503},
  [82] = { ._label = "CN3 Canoe NE", ._m5label = "CN3\nCanoe NE", ._lat = 51.4621235, ._long = -0.5488664},
  [83] = { ._label = "CN4 Canoe E", ._m5label = "CN4\nCanoe E", ._lat = 51.4620654, ._long = -0.5488102},
  [84] = { ._label = "CN5 Canoe SE", ._m5label = "CN5\nCanoe SE", ._lat = 51.4620027, ._long = -0.5488524},
  [85] = { ._label = "CN6 Canoe S", ._m5label = "CN6\nCanoe S", ._lat = 51.4619701, ._long = -0.5489477},
  [86] = { ._label = "CN7 Canoe SW", ._m5label = "CN7\nCanoe SW", ._lat = 51.4619939, ._long = -0.5490341},
  [87] = { ._label = "CN8 Canoe W", ._m5label = "CN8\nCanoe W", ._lat = 51.4620666, ._long = -0.5490951},

  [88] = { ._label = "SS1 Sub W", ._m5label = "SS1\nSub W", ._lat = 51.4609559, ._long = -0.5492975},
  [89] = { ._label = "SS2 Sub NW", ._m5label = "SS2\nSub NW", ._lat =  51.461031, ._long = -0.5492317},
  [90] = { ._label = "SS3 Sub N", ._m5label = "SS3\nSub N", ._lat = 51.4610407, ._long = -0.5491586},
  [91] = { ._label = "SS4 Sub NE", ._m5label = "SS4\nSub NE", ._lat = 51.4610231, ._long = -0.5490675},
  [92] = { ._label = "SS5 Sub E", ._m5label = "SS5\nSub E", ._lat = 51.4609554, ._long = -0.5490171},
  [93] = { ._label = "SS6 Sub SE", ._m5label = "SS6\nSub SE", ._lat =  51.460884, ._long = -0.5490634},
  [94] = { ._label = "SS7 Sub S", ._m5label = "SS7\nSub S", ._lat = 51.4608669, ._long = -0.5491586},
  [95] = { ._label = "SS8 Sub SW", ._m5label = "SS8\nSub SW", ._lat = 51.4608861, ._long = -0.5492377},
